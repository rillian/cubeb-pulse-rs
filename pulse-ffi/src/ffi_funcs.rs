...
mod static_fns {
    use libc::{c_char,c_double,c_int,c_float,c_uint,c_void};
    use libc::{int64_t,uint32_t,size_t};
    use super::*;
    ...
    extern "C" {
        ...
        pub fn pa_context_get_sink_input_info(c: *const pa_context, idx: uint32_t, cb: pa_sink_input_info_cb_t, userdata: *mut c_void) -> *mut pa_operation;
        ...
        pub fn pa_context_set_sink_input_volume(c: *mut pa_context, idx: uint32_t, volume: *const pa_cvolume, cb: pa_context_success_cb_t, userdata: *mut c_void) -> *mut pa_operation;
        ...
        pub fn pa_stream_peek(p: *mut pa_stream, data: *mut *const c_void, nbytes: *mut size_t) -> c_int;
        ...
        pub fn pa_stream_write(p: *mut pa_stream, data: *const c_void, nbytes: size_t, free_cb: pa_free_cb_t, offset: int64_t, seek: pa_seek_mode_t) -> c_int;
        ...
        pub fn pa_usec_to_bytes(t: pa_usec_t, spec: *const pa_sample_spec) -> size_t;
...
mod dynamic_fns {
    ...
    #[inline]
    pub unsafe fn pa_context_get_sink_input_info(c: *const pa_context, idx: uint32_t, cb: pa_sink_input_info_cb_t, userdata: *mut c_void) -> *mut pa_operation {
        (::std::mem::transmute::<_, extern fn(*const pa_context, uint32_t, pa_sink_input_info_cb_t, *mut c_void) -> *mut pa_operation>(PA_CONTEXT_GET_SINK_INPUT_INFO))(c, idx, cb, userdata)
    }
    ...
    #[inline]
    pub unsafe fn pa_context_set_sink_input_volume(c: *mut pa_context, idx: uint32_t, volume: *const pa_cvolume, cb: pa_context_success_cb_t, userdata: *mut c_void) -> *mut pa_operation {
        (::std::mem::transmute::<_, extern fn(*mut pa_context, uint32_t, *const pa_cvolume, pa_context_success_cb_t, *mut c_void) -> *mut pa_operation>(PA_CONTEXT_SET_SINK_INPUT_VOLUME))(c, idx, volume, cb, userdata)
    }
    ...
    #[inline]
    pub unsafe fn pa_frame_size(spec: *const pa_sample_spec) -> size_t {
        (::std::mem::transmute::<_, extern fn(*const pa_sample_spec) -> size_t>(PA_FRAME_SIZE))(spec)
    }
    ...
    #[inline]
    pub unsafe fn pa_stream_begin_write(p: *mut pa_stream, data: *mut *mut c_void, nbytes: *mut size_t) -> c_int {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream, *mut *mut c_void, *mut size_t) -> c_int>(PA_STREAM_BEGIN_WRITE))(p, data, nbytes)
    }
    ...
    #[inline]
    pub unsafe fn pa_stream_get_index(s: *const pa_stream) -> uint32_t {
        (::std::mem::transmute::<_, extern fn(*const pa_stream) -> uint32_t>(PA_STREAM_GET_INDEX))(s)
    }
    ...
    #[inline]
    pub unsafe fn pa_stream_peek(p: *mut pa_stream, data: *mut *const c_void, nbytes: *mut size_t) -> c_int {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream, *mut *const c_void, *mut size_t) -> c_int>(PA_STREAM_PEEK))(p, data, nbytes)
    }

    static mut PA_STREAM_READABLE_SIZE: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_readable_size(p: *const pa_stream) -> size_t {
        (::std::mem::transmute::<_, extern fn(*const pa_stream) -> size_t>(PA_STREAM_READABLE_SIZE))(p)
    }
    ...
    #[inline]
    pub unsafe fn pa_stream_writable_size(p: *const pa_stream) -> size_t {
        (::std::mem::transmute::<_, extern fn(*const pa_stream) -> size_t>(PA_STREAM_WRITABLE_SIZE))(p)
    }

    static mut PA_STREAM_WRITE: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_write(p: *mut pa_stream, data: *const c_void, nbytes: size_t, free_cb: pa_free_cb_t, offset: int64_t, seek: pa_seek_mode_t) -> c_int {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream, *const c_void, size_t, pa_free_cb_t, int64_t, pa_seek_mode_t) -> c_int>(PA_STREAM_WRITE))(p, data, nbytes, free_cb, offset, seek)
    }
    ...
    #[inline]
    pub unsafe fn pa_usec_to_bytes(t: pa_usec_t, spec: *const pa_sample_spec) -> size_t {
        (::std::mem::transmute::<_, extern fn(pa_usec_t, *const pa_sample_spec) -> size_t>(PA_USEC_TO_BYTES))(t, spec)
    }
    ...
    #[inline]
    pub unsafe fn pa_xrealloc(ptr: *mut c_void, size: size_t) -> *mut c_void {
        (::std::mem::transmute::<_, extern fn(*mut c_void, size_t) -> *mut c_void>(PA_XREALLOC))(ptr, size)
    }
